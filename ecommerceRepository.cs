...
namespace ecommerceAccessLayer.DataLayer
{
    public class ecommerceRepository
    {
        ...
        public List<CategoryModel> GetPaginatedCategory(int pageIndex, int pageSize)
        {
            ...
            try
            {
                ...
                dt = engine.ExecuteProcedureDatatable(sp.ProcedureName, conn, sp.ParameterList);
                if (dt != null && dt.Rows.Count > 0)
                {
                    DataNamesMapper<Project> project = new DataNamesMapper<Project>();
